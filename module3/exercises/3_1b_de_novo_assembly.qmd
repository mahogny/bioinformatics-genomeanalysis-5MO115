...
- **QE1.9** Short reads give per-base accuracy but fragment at repeats; long reads span repeats but have a higher per-base error rate. Sketch a **hybrid** assembly workflow that combines the two. What does each read type contribute?

::: {.callout-tip collapse="true" appearance="minimal"}
## Hint
Use one read type for *contiguity / structure* and the other for *base-level correctness*. In what order would you apply them?
:::
